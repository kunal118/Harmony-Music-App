    ...
    <div className="wrapper1">
      ...
      <div className="wrapper1-2">
        <div className="wrapper1-2-1">
          <div  className="searchbar button-85">
            <input
              className="searchbox"
        ...
        <div className="wrapper1-2-2">
          <div className="wrapper1-2-2-1">
            ...
            <iframe id = "splayer" className = "songPlayer"  src={props.currentSong}  width="100%"  height = "100%" frameBorder="0"  allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" ></iframe>
            </div>
            
          </div>
          <div className="wrapper1-2-2-2">
          <div className = "wrapper1-2-2-2-1"><Like /></div>
            <div className = "wrapper1-2-2-2-2"><Volume volume = {props.volume} setVolume = {props.setVolume}/></div>
